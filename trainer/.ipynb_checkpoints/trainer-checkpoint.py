...
class Trainer:
    def __init__(self, args, model, plm_model, logger, train_loader):
        ...
        if self.args.training_method in ['plm-lora', 'plm-qlora', 'plm-dora', 'plm-adalora', 'plm-ia3']:
    ...
    def _setup_loss_function(self):
        if self.args.problem_type == 'single_label_classification' and self.args.num_labels == 2:
            # For binary sequence labeling, use CrossEntropyLoss
    ...
    def _save_model(self, path):
        if self.args.training_method == "plm-lora":
